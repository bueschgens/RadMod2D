...
# 2D plot of model
fig1 = Figure(resolution = (500, 500), font = "Arial", fontsize = 12)
ax1 = fig1[1,1] = Axis(fig1)
ax1.xlabel = "X in m"
ax1.ylabel = "Y in m"
ax1.aspect = DataAspect()
plot_model(fig1, ax1, m, shownvec = true, shownodes = false, showcom = false, showleg = true, legpos = "bottom")
...
fig2 = Figure(resolution = (500, 500), font = "Arial", fontsize = 12)
ax2 = fig2[1,1] = Axis(fig2)
ax2.xlabel = "X in m"
ax2.ylabel = "Y in m"
ax2.aspect = DataAspect()
cbar = plot_model_with_value(fig2, ax2, m, q, "Heat flux density in W/m", cmap = :jet, showcbar = true, cbarpos = "bottom")
